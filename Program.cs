...
static void PrintMenuHeader()
{
    ...
    Console.WriteLine("║  10. Пошук за фрагментом     25. Типи студентів (GetInfo)  ║");
    Console.WriteLine("║  11. Звіт (SB)               26. Фільтр за типом            ║");
    Console.WriteLine("║  12. Нормалізація            27. Стипендії + фонд          ║");
    Console.WriteLine("║  13. Паліндроми в нотатках   28. Зарахування (Enroll)      ║");
    Console.WriteLine("║  14. Експорт у CSV           29. Vehicle демо              ║");
    Console.WriteLine("║  15. Імпорт з тексту         30. Поліморфізм (Vehicle)     ║");
    Console.WriteLine("╠══════════════ PR6 (Поліморфізм та Інтерфейси) ══════════════╣");
    Console.WriteLine("║  31. Додати фігуру           35. Малювати фігури (Draw)    ║");
    Console.WriteLine("║  32. Список фігур            36. Інтерфейс (PrintInfo)     ║");
    Console.WriteLine("║  33. Загальна площа          37. Dynamic Binding (Demo)    ║");
    Console.WriteLine("║  34. Змінити розмір          38. Демо платежів (Вар 2)     ║");
